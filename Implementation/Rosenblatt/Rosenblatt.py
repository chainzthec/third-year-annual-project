...
def main():
    ...
    xtrain = (c_double * 26)(*[0, 0, 1, 0, 0, 1, 2, 2, 1, 2, 2, 1, 0.25, 0.25, 0.1, 0.1, 0.15, 0.15, 0.3, 0.3, 3, 3, 1.5, 1.5, 2.5, 2.5])
    ...
    dll.fit_classification.argtypes = [c_void_p, POINTER(ARRAY(c_double, 26)), POINTER(ARRAY(c_double, 13)), c_int32, c_int32, c_float, c_int32]
